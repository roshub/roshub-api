...
const debug = require('debug')('roshub.dataparty.loki-cache')


//const LokiIndexedAdapater = require('lokijs/src/loki-indexed-adapter')
//const LokiAdapter = new LokiIndexedAdapater('roshub-cache')

module.exports = class LokiCache extends EventEmitter {

  constructor () {
    super()
    this.db = new Loki('app.roshub.io/cache')

    this.collections = {} // collections of messages indexed by type
  }
